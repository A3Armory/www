...
class ObjectCount_History_model extends CI_Model {
  ...
  function get($serverId = NULL) {
    ...
    $vehiclesList = $serverConfig["ObjectsList_ID"];
...
EOF;
    ...
    $page = trim($serverConfig["ES_ObjectsList_History_Index"], "/") . "/_search?search_type=count";
